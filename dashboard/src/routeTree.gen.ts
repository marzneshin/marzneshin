...
import { Route as DashboardAdminsImport } from './routes/_dashboard/admins'
...
const DashboardAdminsRoute = DashboardAdminsImport.update({
  path: '/admins',
  getParentRoute: () => DashboardRoute,
} as any)
...
const DashboardAdminsCreateRoute = DashboardAdminsCreateImport.update({
  path: '/create',
  getParentRoute: () => DashboardAdminsRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_dashboard/admins': {
      ...
      path: '/admins'
      fullPath: '/admins'
      preLoaderRoute: typeof DashboardAdminsImport
    ...
    '/_dashboard/admins/$adminId': {
      ...
      parentRoute: typeof DashboardAdminsImport
    }
...
export const routeTree = rootRoute.addChildren({
  ...
  DashboardRoute: DashboardRoute.addChildren({
    DashboardAdminsRoute: DashboardAdminsRoute.addChildren({
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_dashboard/admins": {
      "filePath": "_dashboard/admins.tsx",
      "parent": "/_dashboard",
      "children": [
        "/_dashboard/admins/$adminId",
        "/_dashboard/admins/create"
