...
Domain = _reflection.GeneratedProtocolMessageType('Domain', (_message.Message,), {
  ...
  'Attribute' : _reflection.GeneratedProtocolMessageType('Attribute', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.Domain.Attribute)
    })
  ,
  'DESCRIPTOR' : _DOMAIN,
  '__module__' : 'app.router.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.Domain)
  })
...
CIDR = _reflection.GeneratedProtocolMessageType('CIDR', (_message.Message,), {
  'DESCRIPTOR' : _CIDR,
  '__module__' : 'app.router.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.CIDR)
  })
...
GeoIP = _reflection.GeneratedProtocolMessageType('GeoIP', (_message.Message,), {
  'DESCRIPTOR' : _GEOIP,
  '__module__' : 'app.router.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.GeoIP)
  })
...
GeoIPList = _reflection.GeneratedProtocolMessageType('GeoIPList', (_message.Message,), {
  ...
  '__module__' : 'app.router.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.GeoIPList)
  })
...
GeoSite = _reflection.GeneratedProtocolMessageType('GeoSite', (_message.Message,), {
  'DESCRIPTOR' : _GEOSITE,
  '__module__' : 'app.router.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.GeoSite)
  })
...
GeoSiteList = _reflection.GeneratedProtocolMessageType('GeoSiteList', (_message.Message,), {
  ...
  '__module__' : 'app.router.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.GeoSiteList)
  })
...
RoutingRule = _reflection.GeneratedProtocolMessageType('RoutingRule', (_message.Message,), {
  ...
  'AttributesEntry' : _reflection.GeneratedProtocolMessageType('AttributesEntry', (_message.Message,), {
    ...
    '__module__' : 'app.router.config_pb2'
    # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.RoutingRule.AttributesEntry)
    })
  ,
  'DESCRIPTOR' : _ROUTINGRULE,
  '__module__' : 'app.router.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.RoutingRule)
  })
...
BalancingRule = _reflection.GeneratedProtocolMessageType('BalancingRule', (_message.Message,), {
  ...
  '__module__' : 'app.router.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.BalancingRule)
  })
...
Config = _reflection.GeneratedProtocolMessageType('Config', (_message.Message,), {
  'DESCRIPTOR' : _CONFIG,
  '__module__' : 'app.router.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.Config)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ROUTINGRULE._serialized_end=1396
  _ROUTINGRULE_ATTRIBUTESENTRY._serialized_start=1333
  _ROUTINGRULE_ATTRIBUTESENTRY._serialized_end=1382
  _BALANCINGRULE._serialized_start=1398
  _BALANCINGRULE._serialized_end=1471
  _CONFIG._serialized_start=1474
  _CONFIG._serialized_end=1720
  _CONFIG_DOMAINSTRATEGY._serialized_start=1649
  _CONFIG_DOMAINSTRATEGY._serialized_end=1720
