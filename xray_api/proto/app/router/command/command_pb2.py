...
RoutingContext = _reflection.GeneratedProtocolMessageType('RoutingContext', (_message.Message,), {
  ...
  'AttributesEntry' : _reflection.GeneratedProtocolMessageType('AttributesEntry', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.command.RoutingContext.AttributesEntry)
    })
  ,
  'DESCRIPTOR' : _ROUTINGCONTEXT,
  '__module__' : 'app.router.command.command_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.command.RoutingContext)
  })
...
SubscribeRoutingStatsRequest = _reflection.GeneratedProtocolMessageType('SubscribeRoutingStatsRequest', (_message.Message,), {
  ...
  '__module__' : 'app.router.command.command_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.command.SubscribeRoutingStatsRequest)
  })
...
TestRouteRequest = _reflection.GeneratedProtocolMessageType('TestRouteRequest', (_message.Message,), {
  ...
  '__module__' : 'app.router.command.command_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.command.TestRouteRequest)
  })
...
Config = _reflection.GeneratedProtocolMessageType('Config', (_message.Message,), {
  'DESCRIPTOR' : _CONFIG,
  '__module__' : 'app.router.command.command_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.router.command.Config)
  })
