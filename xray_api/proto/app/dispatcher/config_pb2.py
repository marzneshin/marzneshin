...
SessionConfig = _reflection.GeneratedProtocolMessageType('SessionConfig', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.dispatcher.SessionConfig)
  })
...
Config = _reflection.GeneratedProtocolMessageType('Config', (_message.Message,), {
  'DESCRIPTOR' : _CONFIG,
  '__module__' : 'app.dispatcher.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.dispatcher.Config)
  })
