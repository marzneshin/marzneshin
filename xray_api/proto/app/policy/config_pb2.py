...
Second = _reflection.GeneratedProtocolMessageType('Second', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.policy.Second)
  })
...
Policy = _reflection.GeneratedProtocolMessageType('Policy', (_message.Message,), {
  ...
  'Timeout' : _reflection.GeneratedProtocolMessageType('Timeout', (_message.Message,), {
    ...
    '__module__' : 'app.policy.config_pb2'
    # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.policy.Policy.Timeout)
    })
  ,
  ...
  'Stats' : _reflection.GeneratedProtocolMessageType('Stats', (_message.Message,), {
    ...
    '__module__' : 'app.policy.config_pb2'
    # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.policy.Policy.Stats)
    })
  ,
  ...
  'Buffer' : _reflection.GeneratedProtocolMessageType('Buffer', (_message.Message,), {
    ...
    '__module__' : 'app.policy.config_pb2'
    # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.policy.Policy.Buffer)
    })
  ,
  'DESCRIPTOR' : _POLICY,
  '__module__' : 'app.policy.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.policy.Policy)
  })
...
SystemPolicy = _reflection.GeneratedProtocolMessageType('SystemPolicy', (_message.Message,), {
  ...
  'Stats' : _reflection.GeneratedProtocolMessageType('Stats', (_message.Message,), {
    ...
    '__module__' : 'app.policy.config_pb2'
    # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.policy.SystemPolicy.Stats)
    })
  ,
  'DESCRIPTOR' : _SYSTEMPOLICY,
  '__module__' : 'app.policy.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.policy.SystemPolicy)
  })
...
Config = _reflection.GeneratedProtocolMessageType('Config', (_message.Message,), {
  ...
  'LevelEntry' : _reflection.GeneratedProtocolMessageType('LevelEntry', (_message.Message,), {
    ...
    '__module__' : 'app.policy.config_pb2'
    # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.policy.Config.LevelEntry)
    })
  ,
  'DESCRIPTOR' : _CONFIG,
  '__module__' : 'app.policy.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.app.policy.Config)
  })
