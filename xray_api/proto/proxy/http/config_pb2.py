...
Account = _reflection.GeneratedProtocolMessageType('Account', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.proxy.http.Account)
  })
...
ServerConfig = _reflection.GeneratedProtocolMessageType('ServerConfig', (_message.Message,), {
  ...
  'AccountsEntry' : _reflection.GeneratedProtocolMessageType('AccountsEntry', (_message.Message,), {
    ...
    '__module__' : 'proxy.http.config_pb2'
    # @@protoc_insertion_point(class_scope:xray.xray_api.proto.proxy.http.ServerConfig.AccountsEntry)
    })
  ,
  'DESCRIPTOR' : _SERVERCONFIG,
  '__module__' : 'proxy.http.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.proxy.http.ServerConfig)
  })
...
Header = _reflection.GeneratedProtocolMessageType('Header', (_message.Message,), {
  'DESCRIPTOR' : _HEADER,
  '__module__' : 'proxy.http.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.proxy.http.Header)
  })
...
ClientConfig = _reflection.GeneratedProtocolMessageType('ClientConfig', (_message.Message,), {
  ...
  '__module__' : 'proxy.http.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.proxy.http.ClientConfig)
  })
