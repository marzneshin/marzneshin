...
Fallback = _reflection.GeneratedProtocolMessageType('Fallback', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.proxy.vless.inbound.Fallback)
  })
...
Config = _reflection.GeneratedProtocolMessageType('Config', (_message.Message,), {
  'DESCRIPTOR' : _CONFIG,
  '__module__' : 'proxy.vless.inbound.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.proxy.vless.inbound.Config)
  })
