...
Config = _reflection.GeneratedProtocolMessageType('Config', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.transport.internet.headers.noop.Config)
  })
...
ConnectionConfig = _reflection.GeneratedProtocolMessageType('ConnectionConfig', (_message.Message,), {
  ...
  '__module__' : 'transport.internet.headers.noop.config_pb2'
  # @@protoc_insertion_point(class_scope:xray.xray_api.proto.transport.internet.headers.noop.ConnectionConfig)
  })
