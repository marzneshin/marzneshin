...
SCRIPT_URL="https://github.com/$FETCH_REPO/raw/v0.7.4-my-changes/script.sh"
...
install_marzneshin() {
    # Fetch releases
    FILES_URL_PREFIX="https://raw.githubusercontent.com/mojtaba211/marzneshin/v0.7.4-my-changes"
